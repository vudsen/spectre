...
Provide a development-only browser-console helper for inspecting persisted Arthas channel messages grouped by instance without changing production behavior.
