...
object SecretSupportedObjectMapper {
    private fun secretEncryptorManager(): SecretEncryptorManager =
        ApplicationContextHolder.applicationContext.getBean(SecretEncryptorManager::class.java)

    private fun isEncrypted(propertyWriter: BeanPropertyWriter): Boolean =
        propertyWriter.getAnnotation(Encrypted::class.java) != null ||
    ...
    private fun isEncrypted(property: SettableBeanProperty): Boolean =
        property.getAnnotation(Encrypted::class.java) != null ||
            ...
            .addModule(
                SimpleModule().apply {
                    setSerializerModifier(
                        object : ValueSerializerModifier() {
