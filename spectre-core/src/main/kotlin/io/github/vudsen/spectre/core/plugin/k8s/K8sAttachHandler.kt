        ...
        if (port == null) {
            ...
            runtimeNode
                .execute(
                    ...
                    "instrument",
                    "false",
                    "${paths.arthasHome}/arthas-agent.jar=${paths.arthasHome}/arthas-core.jar;localConnectionNonAuth=false;password=$password;httpPort=${KUBERNETES_LISTEN_PORT};telnetPort=-1;",
                ).ok()
        }
