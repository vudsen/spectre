...
class UserController(
    ...
    fun createUser(
        @Validated @RequestBody dto: CreateUserDTO,
    ) {
    ...
    fun updateUser(
        @Validated @RequestBody dto: UpdateUserDTO,
    ) {
    ...
    fun modifyPassword(
        @RequestBody @Validated vo: ModifyUserPasswordVO,
    ) {
    ...
    fun modifySelfPassword(
        @RequestBody @Validated vo: ModifyPasswordVO,
