...
class K8sPodRuntimeNode(
    ...
    override fun execute(vararg commands: String): CommandExecuteResult = execute(listOf(*commands))
    ...
    override fun execute(command: String): CommandExecuteResult = execute(command.split(' '))
    ...
    class K8sInteractiveShell(
        ...
        override fun getInputStream(): InputStream = client.inputStream

        override fun getWriter(): Writer = writer

        override fun getOutputStream(): OutputStream = outputStream

        override fun isAlive(): Boolean = client.isAlive()
    ...
    override fun createInteractiveShell(command: String): InteractiveShell = createInteractiveShell(command.split(' '))

    override fun getHomePath(): String = conf.spectreHome
