...
class ToolchainQueriesController(
    ...
    @QueryMapping
    fun toolchain(): ToolchainItemQueries = ToolchainItemQueries
    ...
    fun toolchainItems(
        ...
        @Argument page: Int,
        @Argument size: Int,
    ): PageResult<ToolchainItemPO> = toolchainService.listToolchainItems(ToolchainType.valueOf(type), page, size).toPageResult()

    @SchemaMapping(typeName = "ToolchainItemQueries", field = "toolchainBundles")
    fun toolchainBundles(
        @Argument page: Int,
        @Argument size: Int,
    ): PageResult<ToolchainBundlePO> = toolchainService.listToolchainBundles(page, size).toPageResult()

    @SchemaMapping(typeName = "ToolchainItemQueries", field = "toolchainBundle")
    fun toolchainBundle(
        @Argument id: String,
    ): ToolchainBundleDTO? = toolchainService.resolveToolchainBundle(id.toLong())
