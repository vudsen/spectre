...
class DefaultRoleService(
    ...
    override fun findById(id: Long): RolePO? = roleRepository.findById(id).getOrNull()

    override fun boundUsers(
        roleId: Long,
        page: Int,
        size: Int,
    ): Page<UserPO> = roleRepository.findUsersByRoleId(roleId, PageRequest.of(page, size))
    ...
    override fun listRoles(
        page: Int,
        size: Int,
    ): Page<RolePO> = roleRepository.findAll(PageRequest.of(page, size))

    override fun listUserRoles(userId: Long): List<RolePO> = roleRepository.queryAllUserRoles(userId)

    override fun searchByName(
        name: String,
        page: Int,
        size: Int,
    ): Page<RolePO> = roleRepository.searchByNameStartsWith(name, PageRequest.of(page, size))
