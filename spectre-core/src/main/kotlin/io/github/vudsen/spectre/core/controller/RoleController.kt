...
class RoleController(
    ...
    fun bindUser(
        @Validated @RequestBody vo: RoleBindUserRequestVO,
    ) {
    ...
    @PostMapping("create")
    fun createRole(
        @Validated(CreateGroup::class) @RequestBody role: RolePO,
    ) {
    ...
    @PostMapping("update")
    fun updateRole(
        @Validated(UpdateGroup::class) @RequestBody role: RolePO,
    ) {
        roleService.saveRole(role)
    }
    ...
    fun unbindUser(
        @Validated @RequestBody vo: RoleBindVO,
    ) {
