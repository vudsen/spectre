...
class TestRuntimeNodeExtension : TypedRuntimeNodeExtensionPoint<TestRuntimeNodeConfig, TestRuntimeNode>("Test") {
    ...
    override fun getConfigurationClass(): Class<TestRuntimeNodeConfig> = TestRuntimeNodeConfig::class.java

    override fun getConfigurationForm0(oldConfiguration: TestRuntimeNodeConfig?): PageDescriptor = PageDescriptor("form/TestNodeForm", null)

    override fun createRuntimeNode0(config: TestRuntimeNodeConfig): TestRuntimeNode = TestRuntimeNode(config, this)
    ...
    ): JvmAttachHandler = TestAttachHandler()

    override fun getDescription(): String = "A runtime node for test or development."

    override fun isCloseableRuntimeNode(): Boolean = false

    override fun createSearcher(): JvmSearcher = searcher

    override fun getId(): String = "TestRuntimeNodeExtension"
}
