...
class ArthasExecPolicyAuthProvider : PolicyAuthenticationProvider {
    ...
    override fun getPermissionEntity(): PermissionEntity = AppPermissions.RUNTIME_NODE_ARTHAS_EXECUTE

    override fun createExampleContext(): List<PolicyPermissionContextExample> =
        buildList {
            add(
                PolicyPermissionContextExample(
                    "当连接 Docker 时",
                    toContextMap(
                        ArthasExecutionPolicyPermissionContext(
                            ...
                            RuntimeNodeDTO(
                                ...
                                SshRuntimeNodeConfig(
                                    ...
                                    22,
                                    "root",
                                    SshRuntimeNodeConfig.LoginPrincipal(SshRuntimeNodeConfig.LoginType.KEY, null, null, null),
                                    "/opt/spectre",
                                ),
                    ...
                    toContextMap(
                        ArthasExecutionPolicyPermissionContext(
                            ...
                            RuntimeNodeDTO(
                                ...
                                SshRuntimeNodeConfig(
                                    null,
                                    SshRuntimeNodeConfig.Local(true, "/opt/jdk/bin/java"),
                                    "127.0.0.1",
                                    22,
                                    "root",
                                    SshRuntimeNodeConfig.LoginPrincipal(SshRuntimeNodeConfig.LoginType.KEY, null, null, null),
    ...
    override fun customiseErrorException(): BusinessException? = null
}
