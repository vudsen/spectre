...
class GraphQLConfiguration {
        ...
        return GraphQLScalarType
            ...
            .coercing(
                object : Coercing<Timestamp, Long> {
                    ...
                    override fun parseValue(input: Any): Timestamp = Timestamp(input.toString().toLong())
    ...
    fun toolchainType(): GraphQLScalarType {
        return GraphQLScalarType
            ...
            .coercing(
                object : Coercing<ToolchainType, String> {
                    override fun serialize(
                        dataFetcherResult: Any,
                        graphQLContext: GraphQLContext,
                        locale: Locale,
    ...
    fun labels(): GraphQLScalarType {
        return GraphQLScalarType
            ...
            .description("Labels")
            .coercing(
                object : Coercing<Map<String, String>, Map<String, String>> {
                    override fun serialize(
                        dataFetcherResult: Any,
                        graphQLContext: GraphQLContext,
                        locale: Locale,
                    ): Map<String, String>? = dataFetcherResult as Map<String, String>?
            ...
            .coercing(
                object : Coercing<Long, String> {
                    override fun serialize(
                        ...
                        graphQLContext: GraphQLContext,
                        locale: Locale,
                    ): String? = (dataFetcherResult as Long?).toString()

                    override fun parseValue(
                        input: Any,
                        graphQLContext: GraphQLContext,
                        locale: Locale,
                    ): Long? = (input as String?)?.toLong()
