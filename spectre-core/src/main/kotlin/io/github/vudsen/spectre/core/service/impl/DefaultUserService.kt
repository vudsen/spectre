...
class DefaultUserService(
    ...
    override fun listUsers(
        page: Int,
        size: Int,
    ): Page<UserPO> = userRepository.findAll(PageRequest.of(page, size))
    ...
    override fun searchByUsernamePrefix(usernamePrefix: String): Page<UserPO> =
        userRepository.searchByUsernameStartsWith(usernamePrefix, PageRequest.of(0, 10))

    override fun findById(id: Long): UserPO? = userRepository.findById(id).getOrNull()
