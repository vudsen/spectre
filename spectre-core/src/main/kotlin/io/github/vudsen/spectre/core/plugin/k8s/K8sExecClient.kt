...
class K8sExecClient(
    ...
    private fun createWs(): WebSocket {
        ...
        return getHttpCLinet().newWebSocket(
            request,
    ...
    fun waitClose(): CommandExecuteResult = future.get()
    ...
    fun isAlive(): Boolean = !future.isDone

    /**
     * 当 stdin 开启时，使用该命令开启交互式执行
     */
    fun execWithStdinOpen(): WebSocket = createWs()
}
