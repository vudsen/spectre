...
interface RoleRepository :
    JpaRepository<RolePO, Long>,
    QueryByExampleExecutor<RolePO> {
    @Modifying
    ...
    fun deleteUserRoleByRoleId(
        @Param("roleId") roleId: Long,
    )

    fun searchByNameStartsWith(
        namePrefix: String,
        page: Pageable,
    ): Page<RolePO>
}
